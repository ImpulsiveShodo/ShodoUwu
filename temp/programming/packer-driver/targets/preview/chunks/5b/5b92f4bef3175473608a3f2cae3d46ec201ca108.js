    ...
    execute: function () {
      ...
      _export("CatController", CatController = (_dec = ccclass('CatController'), _dec(_class = class CatController extends Component {
        ...
        update(deltaTime) {
          ...
          (_this$characterContro3 = this.characterController) == null ? void 0 : _this$characterContro3.move(this.movement);
          this.movement = v3(0, 0, 0);
        }
...
//# sourceMappingURL=5b92f4bef3175473608a3f2cae3d46ec201ca108.js.map