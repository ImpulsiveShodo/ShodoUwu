    ...
    execute: function () {
      ...
      _export("CatController", CatController = (_dec = ccclass('CatController'), _dec(_class = class CatController extends Component {
        ...
        update(deltaTime) {
          ...
          if (((_this$characterContro3 = this.characterController) == null ? void 0 : _this$characterContro3.isGrounded) === false) {
...
//# sourceMappingURL=5659869d25834818ec9e6db2ba2b3115e0bd2fe4.js.map