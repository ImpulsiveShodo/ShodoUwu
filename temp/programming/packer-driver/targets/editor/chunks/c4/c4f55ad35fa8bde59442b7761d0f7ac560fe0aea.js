  ...
  return {
    ...
    execute: function () {
      ...
      _export("CatController", CatController = (_dec = ccclass('CatController'), _dec(_class = class CatController extends Component {
        ...
        update(deltaTime) {
          var _this$characterContro, _this$characterContro2;
          ...
          let speed = this.speed.clone(); // if (speed.length() == 0) {
          //     return;
          // }

          console.log((_this$characterContro = this.characterController) == null ? void 0 : _this$characterContro.isGrounded, this.name, pos.x, pos.y, pos.z, this.speed.x, this.speed.y, this.speed.z);
          (_this$characterContro2 = this.characterController) == null ? void 0 : _this$characterContro2.move(speed.multiplyScalar(0.01 * deltaTime));
        }
...
//# sourceMappingURL=c4f55ad35fa8bde59442b7761d0f7ac560fe0aea.js.map