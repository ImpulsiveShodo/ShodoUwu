  ...
  return {
    ...
    execute: function () {
      ...
      _export("CatController", CatController = (_dec = ccclass('CatController'), _dec(_class = class CatController extends Component {
        ...
        update(deltaTime) {
          var _this$characterContro2, _this$characterContro3;

          let pos = this.characterController.centerWorldPosition; // if (this.characterController?.isGrounded === false) {
          ...
          (_this$characterContro3 = this.characterController) == null ? void 0 : _this$characterContro3.move(speed.multiplyScalar(5 * deltaTime));
        }
...
//# sourceMappingURL=b1b427d4a29bc779a30e60246df5e2c5b77fc212.js.map